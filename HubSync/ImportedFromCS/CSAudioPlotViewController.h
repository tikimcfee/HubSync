...
@interface CSAudioPlotViewController : NSViewController <AVAudioPlayerDelegate, EZMicrophoneDelegate, NSGestureRecognizerDelegate>
...
@property (strong, nonatomic) IBOutlet NSButton *playAudioButton;
